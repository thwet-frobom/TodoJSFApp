...
<f:view>
        ...
        <h:form>
                <h:commandLink binding="#{todoData.addCommand}" accesskey="n"
                        action="#{todoData.addNew}" value="Add new Todo">
                </h:commandLink>
        </h:form>


        <h:form binding="#{todoData.form}" rendered="false"
                styleClass="todo">
                <h:panelGrid columns="2">
                        <h:outputText value="Title"></h:outputText>
                        <h:inputText value="#{todoData.todo.title}" required="true"
                                requiredMessage="Title is required">
                        </h:inputText>
                        <h:outputText value="Description"></h:outputText>
                        <h:inputTextarea value="#{todoData.todo.description}" cols="40"
                        ...
                        <h:selectOneMenu validatorMessage="required"
                                ...
                                <f:selectItems value="#{todoData.priorities}" />
                        </h:selectOneMenu>
                </h:panelGrid>
                <h:panelGroup>
                        <h:commandButton action="#{todoData.save}" value="Save"
                                accesskey="s">
                        </h:commandButton>
                        <h:commandButton action="#{todoData.cancel}" value="Cancel"
        ...
        <h:form>
                <h:panelGrid columns="2">
                        <h:commandLink id="hide"
                                actionListener="#{todoData.displayTable}" value="Hide Table">
                        </h:commandLink>
                        <h:commandLink id="show"
                                actionListener="#{todoData.displayTable}" value="Show Table">
                        </h:commandLink>
                </h:panelGrid>
        </h:form>

        <%-- Here we start the form for the data table --%>
        <h:form binding="#{todoData.tableForm}">
                <%-- Here we start the data table --%>

                <h:dataTable value="#{todoData.todos}" var="todo"
                        ...
                        <h:column>
                                ...
                                <h:panelGrid columns="2">
                                        <h:commandLink value="delete" action="#{todoData.delete}">
                                                <f:setPropertyActionListener target="#{todoData.todo}"
                                                        value="#{todo}" />
                                        </h:commandLink>
                                </h:panelGrid>
                        </h:column>
